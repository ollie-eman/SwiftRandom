...
public extension Int32 {
    ...
    public static func random(lower: Int = 0, upper: Int = 100) -> Int32 {
...
public extension Date {
    ...
    public static func randomWithinDaysBeforeToday(days: Int) -> Date {
        ...
        guard let rndDate1 = gregorian.date(byAdding: offsetComponents, to: today, wrappingComponents: false) else {
...
public extension ArraySlice {
    ...
    public func randomItem() -> Element? {
        ...
        let index = Int.random(lower: self.startIndex, upper: self.endIndex)
        return self[index]
    }
}
...
public struct Randoms {
    ...
    public static func randomInt(lower: Int = 0, upper: Int = 100) -> Int {
        return Int.random(lower: lower, upper: upper)
    }
    
    public static func randomInt32(lower: Int = 0, upper: Int = 100) -> Int32{
        return Int32.random(lower: lower, upper: upper)
    }
    ...
    public static func randomDouble(lower: Double = 0, upper: Double = 100) -> Double {
        return Double.random(lower: lower, upper: upper)
    }
    
    public static func randomFloat(lower: Float = 0, upper: Float = 100) -> Float {
        return Float.random(lower: lower, upper: upper)
    }
    
    public static func randomCGFloat(lower: CGFloat = 0, upper: CGFloat = 1) -> CGFloat {
        return CGFloat.random(lower: lower, upper: upper)
    }
    ...
    public static func createGravatar(style: Randoms.GravatarStyle = .Standard, size: Int = 80, completion: ((_ image: UIImage?, _ error: NSError?) -> Void)?) {
